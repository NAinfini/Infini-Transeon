...
public sealed class ReadinessAndProbeRoutingTests
{
    ...
    [InlineData("provider.emptyOutput", "ProbeErrorNoOutput")]
    [InlineData("provider.openai.finish.length", "ProbeErrorOutputTruncated")]
    [InlineData("provider.anthropic.finish.maxTokens", "ProbeErrorOutputTruncated")]
    [InlineData("provider.openai.finish.unsupported", "ProbeErrorUnsupportedFinish")]
    [InlineData("provider.anthropic.finish.unsupported", "ProbeErrorUnsupportedFinish")]
